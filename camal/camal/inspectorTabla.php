...
<body>
    ...
    <div class="container">
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo "<td><a href='editarTablaInspector.php?id=" . $row['id_animal'] . "'><img src='./images/icons8-Edit-32.png' alt='Edit'></a></td>";
            echo "<td><a href='deleteInspector.php?id=" . $row['id_animal'] . "'><img src='./images/icons8-Trash-32.png' alt='Delete'></a></td>";
            echo "</tr>";
        }
        echo "</table>";
        ?>
